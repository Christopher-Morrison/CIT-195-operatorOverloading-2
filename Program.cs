...
namespace OperatorOverloading_2
{
    public class Log
    {
        ...
        // overloaded operator + and operator -
        public static Log operator + (Log log1, int num)
        {
            log1.Hours = log1.Hours + num;
            return log1;
        }
        public static Log operator +(Log log1, Log log2)
        {
            log1.Hours = log1.Hours + log2.Hours;
            return log1;
        }
        public static Log operator -(Log log1, int num)
        {
        ...
        {
            bool greater = false;
            if (log1.Hours > log2.Hours) { greater = true; }
            return greater;
        }
        public static bool operator <(Log log1, Log log2)
        {
            bool lesser = false;
            if (log1.Hours < log2.Hours) { lesser = true; }
            return lesser;
        }
    }
